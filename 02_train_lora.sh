#!/usr/bin/env bash
# Stage 2: LoRA fine-tune SmolVLA on hyzhang01/GCA_suction_franka_a01_id0
#
...
DATASET_REPO_ID="hyzhang01/GCA_suction_franka_a01_id0"
BASE_CHECKPOINT="lerobot/smolvla_base"   # published SmolVLA-450M pretrained weights
OUTPUT_DIR="outputs/smolvla_lora_suction_a01"
# Local-only fine-tune; do not push checkpoints to the Hub
POLICY_REPO_ID="local/smolvla_lora_suction_a01"
...
lerobot-train \
  ...
  --job_name=smolvla_lora_suction_a01 \
  --seed=1000
