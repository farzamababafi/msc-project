...
Usage:
    ...
    # or an explicit step
    python 03_evaluate.py --checkpoint outputs/smolvla_lora_suction_a01/checkpoints/004000
"""
...
DEFAULT_CHECKPOINT = Path("outputs/smolvla_lora_suction_a01/checkpoints/last")
